class by_MultiObjects: public Scene
{
    public:
        by_MultiObjects(const char* name):
            Scene(name),
            mRadius(0.1f),
    ...
    public:
                    ...
                    int thread_idx = 0)
        {
            ...
            obj.mClusterSpacing = clusterSpacing;
            obj.mClusterRadius = clusterRadius;
            obj.mClusterStiffness = clusterStiffness;
            obj.mLinkRadius = linkRadius;
            obj.mLinkStiffness = linkStiffness;
            obj.mGlobalStiffness = globalStiffness;
            obj.mSurfaceSampling = surfaceSampling;
            obj.mVolumeSampling = volumeSampling;
            obj.mSkinningFalloff = skinningFalloff;
            obj.mSkinningMaxDistance = skinningMaxDistance;
            obj.mClusterPlasticThreshold = clusterPlasticThreshold;
